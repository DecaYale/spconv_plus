...
static auto registry =
    torch::jit::RegisterOperators("spconv::get_indice_pairs_2d", &spconv::getIndicePair<2>)
        ...
        .op("spconv::get_concat_indice_pairs_4d", &spconv::getConcatIndicePair<4>)
        ...
        .op("spconv::indice_concat_fp32", &spconv::indiceConcat<float>)
        .op("spconv::indice_concat_backward_fp32", &spconv::indiceConcatBackward<float>)
        .op("spconv::indice_concat_half", &spconv::indiceConcat<at::Half>)
        .op("spconv::indice_concat_backward_half",
            &spconv::indiceConcatBackward<at::Half>)
